<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    >
        <div x-ref="editor" @class([
            ...
            'ring-gray-950/10 focus-visible:ring-primary-600 dark:ring-white/20 dark:focus-visible:ring-primary-500 dark:disabled:ring-white/10' => ! $errors->has($getStatePath()),
            'ring-danger-600 focus-visible:ring-danger-600 dark:ring-danger-500 dark:focus-visible:ring-danger-500' => $errors->has($getStatePath()),
        ])></div>
    </div>
</x-dynamic-component>
